...
<div class="container-fluid px-6 py-8">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-800 mb-2">Tambah Pelatihan Baru</h1>
        <p class="text-gray-600">Lengkapi form untuk menambahkan program pelatihan</p>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="id_sektor" 
                                ...
                                @foreach($sektorList as $sektor)
                                    <option value="{{ $sektor->id_sektor }}" {{ old('id_sektor') == $sektor->id_sektor ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <textarea name="persyaratan" rows="3"
                                class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                                placeholder="Persyaratan untuk mengikuti pelatihan...">{{ old('persyaratan') }}</textarea>
                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="durasi_hari" value="{{ old('durasi_hari') }}" min="1"
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="jenis_pelatihan"
                                ...
                                <option value="Hybrid" {{ old('jenis_pelatihan') == 'Hybrid' ? 'selected' : '' }}>Hybrid</option>
                            </select>
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="sertifikat_tersedia" value="1" id="sertifikat" {{ old('sertifikat_tersedia') ? 'checked' : '' }}
                ...
                <div class="bg-white rounded-2xl shadow-lg p-6">
                    ...
                    <a href="{{ route('admin.pelatihan.index') }}" class="block w-full mt-3 px-6 py-3 bg-gray-200 text-gray-700 rounded-xl font-semibold text-center hover:bg-gray-300 transition-all duration-300">
                        Batal
                    </a>
                </div>
            </div>
