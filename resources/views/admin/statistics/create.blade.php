...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">Tambah Data Statistik</h1>
            <p class="text-gray-600 mt-1">Tambahkan data ketenagakerjaan baru</p>
        </div>
                ...
                <div>
                    ...
                    <select id="id_pendidikan" 
                        ...
                        @foreach($pendidikanList as $pendidikan)
                            <option value="{{ $pendidikan->id_pendidikan }}" {{ old('id_pendidikan') == $pendidikan->id_pendidikan ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="id_usia" 
                        ...
                        @foreach($usiaList as $usia)
                            <option value="{{ $usia->id_usia }}" {{ old('id_usia') == $usia->id_usia ? 'selected' : '' }}>
                                {{ $usia->kelompok_usia }}
                            </option>
                        @endforeach
                    </select>
