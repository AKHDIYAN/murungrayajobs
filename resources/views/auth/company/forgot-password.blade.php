...
@section('title', 'Lupa Password - Perusahaan')
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full">
        ...
        <form method="POST" action="{{ route('company.password.email') }}" class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
            @csrf
            ...
            <!-- Submit Button -->
            <button type="submit" 
                    class="w-full bg-gradient-to-r from-orange-600 via-orange-600 to-amber-700 text-white py-3 px-6 rounded-lg font-semibold shadow-md hover:from-orange-700 hover:to-amber-800 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transform hover:scale-105 transition-all duration-200">
